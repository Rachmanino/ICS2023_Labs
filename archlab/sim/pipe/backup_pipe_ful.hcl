# name: 吴童
# id: 2200013212
# I modified the hcl from F_bubble to E_bubble to make use of the load forwarding technique.
...
# modified to use the load forwarding technique
word e_valA = [
...
bool F_stall =
	...
	( E_dstM == d_srcB || (E_dstM == d_srcA && !(D_icode in {IRRMOVQ, IPUSHQ}))) ||
